...
# IO.inspect(PledgeServerHandRolled.create("larry", 10))
# IO.inspect(PledgeServerHandRolled.create("moe", 20))
# IO.inspect(PledgeServerHandRolled.create("curly", 30))
# IO.inspect(PledgeServerHandRolled.create("daisy", 40))
# IO.inspect(PledgeServerHandRolled.create("grace", 50))
